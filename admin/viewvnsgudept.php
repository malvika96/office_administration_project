...
{
	$id=intval($_GET['del']);
	$adn="delete from vnsgu_department where department_id=?";
...
while($row=$res->fetch_object())
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class=" "><?php echo $row->dept;?></td>
                                             
                                            <td><a href="updatevnsgudept.php?department_id=<?php echo $row->department_id;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;
<a href="viewvnsgudept.php?del=<?php echo $row->department_id;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
