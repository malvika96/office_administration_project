...
while($row=$res->fetch_object())
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class=" "><?php echo $row->discription;?></td>
                                             
                                            <td><a href="updatenews.php?news_id=<?php echo $row->news_id;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;
<a href="viewnews.php?del=<?php echo $row->news_id;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
