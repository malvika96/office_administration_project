...
$ret="select * from circular where title like('$nm%')";
...
echo "<td>"; echo $row->circular_id; echo "</td>";
...
echo "<td><a href='updatecirculer.php?circular_id=$row->circular_id' class='btn btn-success fa fa-edit'><b>Edit</b></a>"; echo "&nbsp;&nbsp" ;
echo"<a href='Viewpurchaseparts.php?del=<?php echo $row->circular_id;?>' class='btn btn-danger fa fa-pencil' onclick='return confirm('Do you want to delete');'><b>Delete</b></a>"; echo "</td>";
										echo "</tr>";
	$cnt=$cnt+1;
