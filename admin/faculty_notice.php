...
if(isset($_POST['submit']))
{
	...
	$sql="insert into faculty_notice(title,date,description) values('$tit','$maindate','$de')";
                               ...
                               <div class="col-md-6">
                                    ...
                                    <form role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="8" name="desc" class="form-control" rows="3" required="please input date"></textarea>
                                        </div>
