...
{
	$id=intval($_GET['del']);
	$adn="delete from type_of_class where class_id=?";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="dataTables-example_length"></div></div><div class="col-sm-6"><div id="dataTables-example_filter" class="dataTables_filter"></div></div></div><table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                    ...
                                    <tbody>  
                                    <?php                                    
                                        $ret="select a.class_id,s.stream,a.class from type_of_class a,stream s where a.stream_id=s.stream_id";
...
while($row=$res->fetch_object())
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td><a href="updatetypeofclass.php?class_id=<?php echo $row->class_id;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;
<a href="view_type_of_class.php?del=<?php echo $row->class_id;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
