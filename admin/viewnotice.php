...
{
	$id=intval($_GET['del']);
	$adn="delete from notice where notice_id=?";
...
while($row=$res->fetch_object())
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td><a href="updatenotice.php?notice_id=<?php echo $row->notice_id;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;
<a href="viewnotice.php?del=<?php echo $row->notice_id;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
