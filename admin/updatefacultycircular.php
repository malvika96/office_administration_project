...
if(isset($_POST['submit']))
{
	...
	$Id=$_GET['fcircular_id'];
	$sql="update faculty_circular set title='$tit',date='$maindate',description='$de' where fcircular_id='$Id'";
	if($conn->query($sql)==TRUE)
	{
		header ("Location: viewfacultycircular.php");
	}
	else
	{
		echo "invalid";
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php	
												$Id=$_GET['fcircular_id'];
	$ret="select * from faculty_circular where fcircular_id=?";
