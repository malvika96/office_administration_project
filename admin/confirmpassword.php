                               ...
                               <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="old" class="form-control" required="please input date" />
                                            
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>New Password:</label>
                                            <input type="password" name="new" class="form-control" required="please input date" />
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="password" name="cp" class="form-control" required="please input date"/>
