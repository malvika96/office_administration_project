...
{
	$id=intval($_GET['del']);
	$adn="delete from user_master where uid=?";
...
while($row=$res->fetch_object())
 ...
 <td><a href="updatetypeofclass.php?class_id=<?php echo $row->uid;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;                                          
<a href="viewsignup.php?del=<?php echo $row->uid;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
