...
{
	$id=intval($_GET['del']);
	$adn="delete from contacts where contacts_id=?";
...
<td>                                            
<a href="viewcontacts.php?del=<?php echo $row->contacts_id;?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
