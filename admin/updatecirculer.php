...
if(isset($_POST['submit']))
{
	...
	$Id=$_GET['circular_id'];
	$sql="update circular set title='$tit',date='$maindate',description='$de' where circular_id='$Id'";
	if($conn->query($sql)==TRUE)
	{
		header ("Location: viewcirculars.php");
	}
	else
	{
		echo "invalid";
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php	
												$Id=$_GET['circular_id'];
	$ret="select * from circular where circular_id=?";
